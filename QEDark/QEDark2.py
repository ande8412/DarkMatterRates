...
class QEDark:
    ...
    def get_halo_data(self,mX,q_tensor,Ee_tensor,FDMn,halo_model,isoangle=None,halo_id_params=None,forceCalculate=False,useVerne=False,calcErrors=None):
        ...
        if isoangle is not None:
            ...
            if useVerne:
                ...
                dir = f'./halo_data/modulated/December_mX_0_6_sigma_1e-30_{fdm_str}/'
            elif halo_model =='summer':
                dir = f'./halo_data/modulated/June_mX_0_6_sigma_1e-30_{fdm_str}/'
            else:
    ...
    def p100_function(self,x_values,ne,material):
        from scipy.interpolate import CubicSpline, PchipInterpolator, Akima1DInterpolator,PchipInterpolator
        from numpy import loadtxt
        import torch
