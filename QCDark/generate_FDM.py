...
resultshm = dmr.calculate_rates(mX_array, SI, ionization_model, ionization_parameter, FDM_exp = 0, max_num_electrons = 10, sigmae = crosssection, DoScreen = True, saveData = True, fileName = '../../../FDM/QCDark/FDM1_vesc544pt0-v0238pt0-vE250pt2-rhoX0pt3_nevents_funcp100_QCDark.dat')

resultshm_compare = resultshm.T
resultshm_compare.shape

print("resultshm_compare")
print(resultshm_compare)

resultslm = dmr.calculate_rates(mX_array, SI, ionization_model, ionization_parameter, FDM_exp = 2, max_num_electrons = 10, sigmae = crosssection, DoScreen = True, saveData = True, fileName = '../../../FDM/QCDark/FDMq2_vesc544pt0-v0238pt0-vE250pt2-rhoX0pt3_nevents_funcp100_QCDark.dat')

resultslm_compare = resultslm.T
resultslm_compare.shape

print("resultslm_compare")
print(resultslm_compare)
